...
import { colorPalette, type ColorPalette } from './tokens/color-palette';
import { colorTokens, type ColorToken } from './tokens/colors';
import { typographyTokens, type FontWeight, type TypographyToken } from './tokens/typography';
...
export function Typography({
  ...
  const textColor = (color in colorTokens)
...
function getDefaultElement(variant: TypographyToken): keyof JSX.IntrinsicElements {
  switch (variant) {
    case 'display':
      return 'h1';
    case 'h1':
